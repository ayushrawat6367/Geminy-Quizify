...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        processed_texts = [str(page) for page in self.processor.pages]
        chunked_texts = []
        for text in processed_texts:
            # Your logic for splitting long sections into smaller chunks goes here
            chunked_texts.extend(text)
        ...
        # Assuming texts is a list of strings representing document content
        documents = [Document(page_content=text) for text in texts]

        # Initialize the Chroma collection with the embeddings model and document objects
    ...
    def as_retriever(self):
        """
        Returns a retriever object that can be used for querying the Chroma collection.
        """
        if self.db:
