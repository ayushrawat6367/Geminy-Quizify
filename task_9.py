...
class QuizManager:
    ...
    def next_question_index(self, direction=1):
        ...
        current_index = st.session_state["question_index", 0]
    ...
    if question_bank:
        ...
        with st.container():
            ...
            with st.form("Multiple Choice Question"):
                ...
                # choices = []
                # for i, choice in enumerate(index_question['choices']): # For loop unpack the data structure
                #     ##### YOUR CODE HERE #####
                #     # Set the key from the index question 
                #     key, value = i+1, choice
                #     # key = chr(ord('A') + i)
